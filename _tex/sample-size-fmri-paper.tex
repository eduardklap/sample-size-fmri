...
sample sizes neither the HDCIs nor the average interval contain the
value zero (see Figure~\ref{fig-1-total} C). Additionally, the
probability that an interval does not contain the value zero equals
...
\includegraphics{sample-size-fmri-paper_files/figure-latex/figures-cohens_d-fig-1-total-output-1.png}
...
\includegraphics{sample-size-fmri-paper_files/figure-latex/figures-cohens_d-fig-2-total-output-1.png}
...
\includegraphics{sample-size-fmri-paper_files/figure-latex/figures-correlations-fig-3-total-output-1.png}
...
\includegraphics{sample-size-fmri-paper_files/figure-latex/figures-correlations-fig-4-total-output-1.png}
